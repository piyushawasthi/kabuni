...
RSpec.describe Link, :type => :model do
  it 'should standardize target_url by removing http://' do
    link = Link.new(:shorten => 'test', :target_url => 'http://example.com')
  ...
  it 'should standardize target_url by removing https://' do
    link = Link.new(:shorten => 'test', :target_url => 'https://example.com')
    link.standardize_target_url!
  ...
  it 'should return correct visit count' do
    link = Link.create(:shorten => 'test', :target_url => 'https://example.com')
    5.times do
      link.visits.create
    end
